...
find_jaccard_overlap = vison_utils.find_jaccard_overlap
...
class VGGBase(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv1_1 = nn.Conv2d(1, 64, kernel_size=3, padding=1)  # stride = 1, by default #vtedit for 3 to 1 in input channels
        ...
        #self.load_pretrained_layers()  #vtedit
